import DeletingCursor from "@/components/deleting-cursor";
...
export default function Home() {
  ...
  const { setTrigger } = useContext(MusicAPIContext);
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24 ">
      ...
      <div className="text-center">
        ...
        <p>
          Share your favourite playlists with your friends and have it sync
